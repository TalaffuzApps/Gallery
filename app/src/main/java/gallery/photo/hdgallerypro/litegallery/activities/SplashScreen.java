...
import gallery.photo.hdgallerypro.litegallery.LookForMediaJob;
...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "gallery.photo.hdgallerypro.litegallery.OPEN_ALBUM";

    //private Album tmpAlbum;
    @BindView(R.id.txtClickable) TextView txtClickable;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(gallery.photo.hdgallerypro.litegallery.R.layout.activity_splash);
        ...
        {
            //do nothing, till user agrees to terms and privacy policy.
        }
        txtClickable.setMovementMethod(LinkMovementMethod.getInstance());
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), gallery.photo.hdgallerypro.litegallery.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        //findViewById(gallery.photo.hdgallerypro.litegallery.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
