package gallery.photo.hdgallerypro.litegallery.settings;
...
import static gallery.photo.hdgallerypro.litegallery.CardViewStyle.FLAT;
import static gallery.photo.hdgallerypro.litegallery.CardViewStyle.MATERIAL;
        ...
        rGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                Glide.with(getActivity())
                        .load(R.drawable.preview_header)
                        .into(img);
