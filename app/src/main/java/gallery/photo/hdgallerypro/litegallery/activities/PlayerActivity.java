...
import gallery.photo.hdgallerypro.litegallery.views.videoplayer.CustomExoPlayerView;
import gallery.photo.hdgallerypro.litegallery.views.videoplayer.CustomPlayBackController;
import gallery.photo.hdgallerypro.litegallery.views.videoplayer.TrackSelectionHelper;
...
public class PlayerActivity extends BaseActivity implements CustomPlayBackController.VisibilityListener {
    ...
    HttpDataSource.Factory buildHttpDataSourceFactory(DefaultBandwidthMeter bandwidthMeter) {
        return new DefaultHttpDataSourceFactory(Util.getUserAgent(this, "Gallery"), bandwidthMeter);
    }

    private HttpDataSource.Factory buildHttpDataSourceFactory(boolean useBandwidthMeter) {
        return new DefaultHttpDataSourceFactory(Util.getUserAgent(this, "Gallery"), useBandwidthMeter ? BANDWIDTH_METER : null);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(gallery.photo.hdgallerypro.litegallery.R.menu.menu_video_player, menu);
