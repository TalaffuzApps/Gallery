...
import gallery.photo.hdgallerypro.litegallery.settings.CardViewStyleSetting;
import gallery.photo.hdgallerypro.litegallery.settings.ColorsSetting;
import gallery.photo.hdgallerypro.litegallery.settings.GeneralSetting;
import gallery.photo.hdgallerypro.litegallery.settings.MapProviderSetting;
import gallery.photo.hdgallerypro.litegallery.settings.SinglePhotoSetting;
import gallery.photo.hdgallerypro.litegallery.util.Security;
import gallery.photo.hdgallerypro.litegallery.views.SettingWithSwitchView;
...
public class SettingsActivity extends BaseActivity {
    ...
    public void updateUiElements() {
        ...
        findViewById(gallery.photo.hdgallerypro.litegallery.R.id.setting_background).setBackgroundColor(getBackgroundColor());
        setStatusBarColor();
        setNavBarColor();
        setRecentApp(getString(gallery.photo.hdgallerypro.litegallery.R.string.settings));
    }
