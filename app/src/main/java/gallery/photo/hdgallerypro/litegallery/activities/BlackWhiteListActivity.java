...
import gallery.photo.hdgallerypro.litegallery.data.filter.ImageFileFilter;
...
public class BlackWhiteListActivity extends SharedMediaActivity {
    ...
    public void updateUiElements(){
        ...
        findViewById(gallery.photo.hdgallerypro.litegallery.R.id.rl_ea).setBackgroundColor(getBackgroundColor());
    }
