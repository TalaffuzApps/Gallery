...
import gallery.photo.hdgallerypro.litegallery.data.sort.AlbumsComparators;
...
public class AlbumsAdapter extends ThemedAdapter<AlbumsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final AlbumsAdapter.ViewHolder holder, int position) {
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(gallery.photo.hdgallerypro.litegallery.R.drawable.ic_error)
        ...
        if(Prefs.showMediaCount()){
            holder.name.setText(holder.name.getText()+" ("+String.valueOf(a.getCount())+")");
        }
